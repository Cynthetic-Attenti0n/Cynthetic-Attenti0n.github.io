...
function addProjectButtonListeners() {
    ...
    viewButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            // Special case for TummyTime - redirect instead of showing modal
            if (project && project.title === 'TummyTime') {
                // Navigate to the TummyTime page
                window.location.href = "AJ/TummyTime/";
...
// Open project modal with enhanced animation
